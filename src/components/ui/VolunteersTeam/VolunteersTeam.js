...
import p2 from "../../../assets/team/p5.jpg";
import p3 from "../../../assets/team/p6.jpg";
import p4 from "../../../assets/team/p7.jpg";
    ...
    <div className="max-w-[1920px] mx-auto min-h-[90vh] bg-light py-20 ">
      <div className="max-w-[1440px] mx-auto">
        <div className="flex flex-col items-center justify-center ">
          <h4
            className="text-4xl font-bold tracking-wide text-secondary"
            style={{ fontFamily: satisfy.style.fontFamily }}
          >
            Our Team
          </h4>
          <h2
            className="text-5xl font-semibold mb-4 mt-2 text-darkLight"
            style={{ fontFamily: yatra.style.fontFamily }}
          >
            Meet Our Volunteers!
          </h2>
          <p className="text-gray-500  max-w-3xl text-center mt-4 mb-12">
